...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno)
    {
      ...
      String occupationValues[]={"Salered","Self-Employed","Bussiness","Student","Retired","Others"};
      ...
      pan=new JTextField();
      pan.setFont(new Font("Ralway",Font.BOLD, 24));
      ...
      aadhar.setFont(new Font("Ralway",Font.BOLD, 24));
